      ...
      <section className="relative w-full bg-black text-white py-32 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-200">
            Have questions or want to work with us? Fill the form or contact us directly via WhatsApp, email, or phone.
          </p>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="flex flex-col items-center p-4 bg-white shadow-md hover:shadow-lg transition ">
                  ...
                  <a href="https://wa.me/263772675611" className="text-gray-600 text-sm">
                    +263 776 5324
                  </a>
                </div>
